(function() {
    ...
    var locales = { "diaspora_infos" : { "en" : '<strong>Diaspora*</strong> is the social network\'s future with real cares about privacy. If you\'re interested about it, go to <a href="http://diasporaproject.org/" mtitle="Join Diaspora*" target="_blank">JoinDiaspora.com</a>.',
                                         "fr" : '<strong>Diaspora*</strong> est le r&eacute;seau social du futur qui se soucie vraiment de la confidentialit&eacute; des donn&eacute;es que vous y mettez. Si &ccedil;a vous int&eacute;resse, rendez-vous sur <a href="http://diasporaproject.org/" title="Join Diaspora*" target="_blank">JoinDiaspora.com</a>.' },

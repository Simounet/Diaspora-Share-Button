(function() {
	...
	var locales = { "diaspora_infos" : { "en" : '<strong>Diaspora*</strong> is the social network of the future with real cares about privacy. If you\'re interested about it, go to <a href="https://diasporafoundation.org/" title="The Diaspora* Foundation" target="_blank">The Diaspora* Foundation</a>.',
										 "fr" : '<strong>Diaspora*</strong> est le r&eacute;seau social du futur qui se soucie vraiment de la confidentialit&eacute; des donn&eacute;es que vous y mettez. Si &ccedil;a vous int&eacute;resse, rendez-vous sur <a href="https://diasporafoundation.org/" title="The Diaspora* Foundation" target="_blank">The Diaspora* Foundation</a>.' },
